# ROADMAP.SH FRONTEND DEVELOPMENT | PROJECT 7 : https://roadmap.sh/projects/age-calculator
...
## How to Run:
* You need to have **Node.js** and **npm** installed within you machine 

* Clone or Download this Repository.
    ```bash 
    git clone https://github.com/jFiesta11/Roadmap.sh-Frontend-Project-7---Age-Calculator-Calendar.git
    ```
